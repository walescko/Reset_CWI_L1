//classe dos Personagens da aula de Orientação da Objetos do Reset CWI
public class Personagem {
    ...
    /*public int setMoedas(int m) { //método criado para soma das moedas coletada pelos jogadores
        this.moedas = this.moedas + m;
        return this.moedas;
    }*/

    public void status() {
        System.out.println(" --- Mario CWI Reset --- ");
